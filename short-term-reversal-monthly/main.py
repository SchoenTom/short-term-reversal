...
def main():
    ...
    print(f"\nSummary Statistics:")
    print(f"{'Period':<25} {'Return':>10} {'Vol':>10} {'Sharpe':>10} {'Sortino':>10} {'Calmar':>10} {'N':>6}")
    print(f"{'-'*100}")
    print(f"{'Full (1926-2024)':<25} {perf['ann_return']:>9.2%} {perf['ann_vol']:>9.2%} {perf['sharpe']:>10.3f} {perf['sortino']:>10.3f} {perf['calmar']:>10.3f} {perf['n']:>6}")
    print(f"{'Pre-1990':<25} {perf_pre['ann_return']:>9.2%} {perf_pre['ann_vol']:>9.2%} {perf_pre['sharpe']:>10.3f} {perf_pre['sortino']:>10.3f} {perf_pre['calmar']:>10.3f} {perf_pre['n']:>6}")
    print(f"{'Post-1990':<25} {perf_post['ann_return']:>9.2%} {perf_post['ann_vol']:>9.2%} {perf_post['sharpe']:>10.3f} {perf_post['sortino']:>10.3f} {perf_post['calmar']:>10.3f} {perf_post['n']:>6}")
    ...
    ax6.set_title('Sortino Ratio by Period: Pre vs Post Publication', fontsize=14, fontweight='bold')
    ax6.set_xticks(x)
    ...
    ax7.set_title('Calmar Ratio by Period: Pre vs Post Publication', fontsize=14, fontweight='bold')
    ax7.set_xticks(x)
